...
- [KeyFile（C# 编译器选项）](../compiler-options/security.md#keyfile)而不是 <xref:System.Reflection.AssemblyKeyFileAttribute> 属性。  
  
- [KeyContainer（C# 编译器选项）](../compiler-options/security.md#keycontainer)而不是 <xref:System.Reflection.AssemblyKeyNameAttribute>。  
  
- [DelaySign（C# 编译器选项）](../compiler-options/security.md#delaysign)而不是 <xref:System.Reflection.AssemblyDelaySignAttribute>。  
